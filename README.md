...
This application is abasic HTML5/ Ionic Hybrid client side template, it should be used in combination with the [HelloWorld cloud app](https://github.com/feedhenry-templates/helloworld-cloud). Refer to `www/fhconfig.json` for configuration.
